...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*Tutorial.Patch> printExpr (scalarProd :: Pull1 Float -> Pull1 Float -> Data Float)
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\begin{code}
test1 = printExpr $ scalarProd -:: tVec1 tFloat >-> tVec1 tFloat >-> id
\end{code}
...
\begin{code}
drop4 :: Data Index -> Pull1 (Data Word8) -> Pull1 (Data Word8)
drop4 n v = drop n' v'
  where
    n' = between 100 120 n
